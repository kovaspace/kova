...
import { createFacility, getFacilities } from "@/helpers/api";
...
export default function CreateFacility({ accountId }: CreateFacilityProps) {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: async (values: FacilityFormData) =>
      await createFacility(values, accountId),
    onSuccess: () => {
      toast({
        title: "Success",
